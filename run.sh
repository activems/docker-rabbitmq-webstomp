...
HOST_SSL=${3-${default_ssl_dir}}
HOST_LOG=${4-${default_log_dir}}
...
sed -e s/===DEFAULT_USER===/$DEFAULT_USER/g -e s/===DEFAULT_PASS===/$DEFAULT_PASS/g rabbitmq.config.template > rabbitmq.config
